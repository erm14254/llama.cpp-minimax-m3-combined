...
enum llm_kv {
    ...
    LLM_KV_NGRAM_HASH_VOCAB_SIZE,
    LLM_KV_NGRAM_INPUT_OUTPUT_SIZE,
    LLM_KV_NGRAM_SOURCE_VOCAB_SIZE,
    LLM_KV_NGRAM_IGNORED_START,
    LLM_KV_NGRAM_IGNORED_COUNT,
